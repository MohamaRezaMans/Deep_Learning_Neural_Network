...
class AutoencoderConfig(BaseConfig):
    ...
    class training(BaseConfig.training):
        ...
        classifier_hidden_dims = [4] # Dimensions of classifier hidden layers
        ...
        optimizer = "adam" # Optimizer algorithm: "adam", "sgd"
        ...
        class trainer(BaseConfig.training.trainer):
            ...
            add_noise = False # Noise injection for training data
